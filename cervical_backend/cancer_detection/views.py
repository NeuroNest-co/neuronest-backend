...
def predict(request):
    if request.method == 'POST':
        try:
            # Use the form to capture patient details
            ...
            if form.is_valid():
                ...
                patient_id = f'P-{datetime.datetime.now().strftime("%Y-%m-%d")}-{patient.patientId:03}'  # Automatically generated by the database
